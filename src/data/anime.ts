...
const localAnimeList: AnimeItem[] = [
	...
	},
	{
		...
		status: "completed",
		rating: 9.4,
		cover: "/assets/anime/yyjdzz.webp",
		description: "A chaotic family spy action comedy",
		episodes: "27 episodes",
		year: "2024",
		genre: ["Action", "Comedy", "Romance"],
		studio: "SILVER LINK.",
		link: "https://www.bilibili.com/bangumi/media/md22134462",
		progress: 27,
		totalEpisodes: 27,
		startDate: "2024-04",
		endDate: "2024-10",
	},
	{
		...
		status: "completed",
		rating: 8.6,
		cover: "/assets/anime/ngmm.webp",
		description: "A chaotic smoking cat-girl comedy",
		episodes: "10 episodes",
		year: "2026",
		genre: ["Drama", "Comedy"],
		studio: "Bibury Animation Studios",
		link: "https://yanineko-anime.com/",
		progress: 10,
		totalEpisodes: 10,
		startDate: "2026-07",
		endDate: "2026-09",
